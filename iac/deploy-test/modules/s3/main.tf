...
resource "aws_s3_bucket_acl" "replication_bucket_acl" {
  ...
  acl      = "private"
  #test
  depends_on = [aws_s3_bucket_ownership_controls.replication_bucket_acl_ownership]
}
...
#test
resource "aws_s3_bucket_ownership_controls" "replication_bucket_acl_ownership" {
  bucket = aws_s3_bucket.replication_bucket.id
  rule {
